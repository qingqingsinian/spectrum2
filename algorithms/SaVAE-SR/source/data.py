...
class KPISeries(object):
    ...
    @lru_cache()
    def normalize(self, mean=None, std=None, return_statistic=False) -> Union[KPISeries, Tuple[KPISeries, float, float]]:
    ...
    def split(self, radios) -> Tuple[KPISeries, KPISeries]:
        """
    ...
    @lru_cache()
    def label_sampling(self, sampling_rate: float = 1.) -> KPISeries:
        """
