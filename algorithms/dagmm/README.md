Support for SMAP, MSL, PSM, SWAT, SMD datasets
数据集放在data目录下
prepare data: python process_data.py 
train and test :
msl ex:python main.py --dataset msl --mode train
python main.py --dataset msl --mode test 
